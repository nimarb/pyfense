...
class PyFenseAbout(menu.Menu):
    def __init__(self):
        ...
        abtText = menu.MenuItem("PyFense is a Tower Defense style game made\
                                by five students at TUM", self.void)
        # abtText.label.position = 512, 600
        # self.super(abtText, self).item["font_size"] = 14
        # aboutText = text.Label("PyFense is a Tower Defense style game made\
        # by five students at TUM",
        #    font_size=14, anchor_x='center', anchor_y='center')
        # aboutText = pyglet.text.Label("asdasdsd", font_size=14,
